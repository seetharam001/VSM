...
export default function CustomerProfile() {
  ...
  useEffect(() => {
    authApi.getMe().then(r => {
      ...
      resetProfile({ name: p.profile?.name, phone: p.profile?.phone, address: p.profile?.address });
    ...
    <DashboardLayout title="My Profile">
      ...
      <div className="card" style={{ display: 'flex', gap: 24, alignItems: 'center', marginBottom: 20 }}>
        ...
        <div>
          ...
          <div style={{ color: 'var(--primary-light)', fontSize: '0.875rem' }}>Customer Account</div>
        </div>
      </div>
        ...
        <div className="card" style={{ maxWidth: 560 }}>
          ...
          <form onSubmit={hProfile(onProfileSave)}>
            ...
            <div className="form-group">
              ...
              <textarea className="form-control" {...rProfile('address')} rows={3} />
            </div>
            <div className="form-group">
